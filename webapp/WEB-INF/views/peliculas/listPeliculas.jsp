...
<html lang="en">
  <head>
    ...
    <spring:url value="/peliculas/create" var="urlNueva"/>
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="table-responsive">
        <table class="table table-hover table-striped table-bordered">
            ...
            <c:forEach items="${peliculas.content}" var="lista">
	           	<tr>            
	                <td>${lista.titulo }</td>
	                <td>${lista.genero }</td>
	                <td>${lista.clasificacion }</td>
	                <td>${lista.duracion } min.</td>
	                <td>${lista.fechaEstreno }</td>
	                <c:choose>
	                	<c:when test="${lista.estatus == 'Activa'}">
	                ...
	                <td>
	                    ...
	                    <a href="${urlDelete}/${lista.id}" onclick='return confirm("¿Estas seguro?")' class="btn btn-danger btn-sm" role="button" title="Eliminar" ><span class="glyphicon glyphicon-trash"></span></a>
	                </td>
	            </tr>
            </c:forEach>
        </table>
