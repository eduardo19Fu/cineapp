         ...
         <form:form class="form-horizontal" method="post" action="${urlRoot}contacto" modelAttribute="contacto">
            ...
            <div class="form-group">
               ...
               <div class="col-sm-10">
               	  ...
               	  <%-- 
                  <label><form:checkbox path="notificaciones" value="Estrenos" />Estrenos</label>
                  <label><form:checkbox path="notificaciones" value="Promociones" />Promociones</label>
                  <label><form:checkbox path="notificaciones" value="Noticias" />Noticias</label>
                  <label><form:checkbox path="notificaciones" value="Preventas" />Preventas</label>
                  --%>
